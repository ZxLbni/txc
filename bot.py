...
USER_AGENT = "Mozilla/5.0 (Macintosh; Intel Mac OS X 14_3_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36"
...
def terabox_download():
    ...
    return jsonify({
        'title': file_name,
        'size': file_size,
        'download_link': details['contents'][0]['url'] if details['contents'] else ''
    }), 200
